...
export default function Category() {
    return (
        <div className=" 2xl:container justify-center items-center w-full 2xl:mx-auto lg:px-20 md:py-12 md:px-6">
            {/* <div>
                    <h1 className="text-3xl lg:text-4xl font-semibold text-gray-800 text-center mb-20">Top Selling</h1>
                </div> */}
